...
int main(){
    ...
    while(teste==1){ // permanencia no programa
        printf("\n*********************************************          **************");
        ...
        if (rota==1) {
            ...
            float valorCovencional=103.80;
            float valorExecutivo=109.90;
            float valorLeito=139.90;
            ...
            float valorCovencional=73.90;
            float valorExecutivo=81.10;
            float valorLeito=88.42;
